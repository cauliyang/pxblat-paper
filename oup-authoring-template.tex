...
\title[Short Article Title]{PxBLAT: An Ergonomics and Efficient Python Binding Library for BLAT}

\author[1]{Yangyang Li\ORCID{0000-0001-8224-1067}}
% \author[2]{Second Author}
% \author[3]{Third Author}
% \author[3]{Fourth Author}
\author[1,$\ast$]{Rendong Yang\ORCID{0000-0000-0000-0000}}

\authormark{Yangyang et al.}

\address[1]{\orgdiv{Department of Urology}, \orgname{Northwestern University, Feinberg School of Medicine}, \orgaddress{\street{420 E. Superior St.}, \postcode{60611}, \state{IL}, \country{US}}}
